...
for year in range(2011, 2025):
    year_str = str(year)
    if year_str not in local_data: continue
    ...
    for period in range(1, final_scoring_period + 1):
        if year >= 2018:
            ...
            url = f"https://lm-api-reads.fantasy.espn.com/apis/v3/games/ffl/leagueHistory/{league_id}?seasonId={year}&view=mMatchup&view=mMatchupScore&scoringPeriodId={period}"
